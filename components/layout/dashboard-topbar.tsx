...
export function DashboardTopbar({ onMenu }: { onMenu: () => void }) {
  ...
  async function logout() {
    ...
    setLoggingOut(true);
    try {
      await apiRequest("/api/auth/logout", jsonRequest("POST"));
    } finally {
